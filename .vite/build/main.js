...
const en = {
  ...
  contract: {
    ...
    contractTotalAmount: "Contract total",
    contractTotalImportLine: "Import currency : {amount}",
    contractTotalRmbLine: "RMB conversion: {amount} RMB",
    contractFactoryRmbLine: "Factory amount : {amount} RMB",
...
const zh = {
  ...
  contract: {
    ...
    contractTotalImportLine: "进口换算：{amount}",
    contractTotalRmbLine: "人名币换算：{amount} RMB",
    contractFactoryRmbLine: "工厂金额换算：{amount} RMB",
