export default {
  ...
  contract: {
    ...
    useVpnOff: '不使用',
    vpnUrlLabel: 'VPN设置',
    vpnUrlPlaceholder: '请输入需要登录的VPN/统一认证入口地址',
    vpnSetupBtn: '设置',
    vpnCookieLabel: 'Cookie设置',
    vpnCookiePlaceholder: '点击“设置”后完成统一认证登录，Cookie 将自动回填到这里',
    selectVersion: '请选择版本',
    accountSection: '账号设置',
    ...
    msgVpnUrlRequired: '请先输入 VPN 地址',
    msgEnableVpnFirst: '请先开启 VPN 开关',
    msgVpnFeatureUnavailable: '当前环境不支持打开认证窗口',
    msgVpnCookieFetchSuccess: '获取 Cookie 成功',
    msgVpnCookieFetchFail: '获取 Cookie 失败，请确认已完成认证登录',
    harborSection: '港口信息设置',
    harborSectionDesc: '根据进口港自动加载运费与附加费，可手动调整',
    mtq: 'MTQ',
    tne: 'TNE',
    freightTwenty: '20尺集装箱基本运费',
    freightForty: '40尺集装箱基本运费',
    portSurchargeTwenty: '20尺集装箱港口附加费',
    portSurchargeForty: '40尺集装箱港口附加费',
    fuelTwenty: '20尺集装箱燃油附加费',
    fuelForty: '40尺集装箱燃油附加费',
    placeholderMtq: '请输入 MTQ',
    placeholderTne: '请输入 TNE',
    placeholderFreightTwenty: '请输入20尺基本运费',
    placeholderFreightForty: '请输入40尺基本运费',
    placeholderPortSurchargeTwenty: '请输入20尺港口附加费',
    placeholderPortSurchargeForty: '请输入40尺港口附加费',
    placeholderFuelTwenty: '请输入20尺燃油附加费',
    placeholderFuelForty: '请输入40尺燃油附加费',
    msgHarborInfoFail: '获取港口信息失败',
    otherSection: '其他设置',
