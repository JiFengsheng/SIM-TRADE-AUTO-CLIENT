export default {
  ...
  contract: {
    ...
    useVpnLabel: 'VPN Switch',
    useVpnOn: 'On',
    useVpnOff: 'Off',
    vpnUrlLabel: 'VPN Settings',
    vpnUrlPlaceholder: 'Enter VPN/SSO login entry URL',
    vpnSetupBtn: 'Setup',
    vpnCookieLabel: 'Cookie Settings',
    vpnCookiePlaceholder: 'After clicking "Setup" and finishing SSO login, cookie will be filled here',
    ...
    msgVpnUrlRequired: 'Please enter VPN URL first',
    msgEnableVpnFirst: 'Please enable VPN switch first',
    msgVpnFeatureUnavailable: 'Current environment does not support auth window',
    msgVpnCookieFetchSuccess: 'Cookie fetched successfully',
    msgVpnCookieFetchFail: 'Failed to fetch cookie, please ensure login is completed',
    harborSection: 'Harbor Settings',
    harborSectionDesc: 'Auto-loaded from import port; values can be edited manually',
    mtq: 'MTQ',
    tne: 'TNE',
    freightTwenty: '20ft base freight',
    freightForty: '40ft base freight',
    portSurchargeTwenty: '20ft port surcharge',
    portSurchargeForty: '40ft port surcharge',
    fuelTwenty: '20ft fuel surcharge',
    fuelForty: '40ft fuel surcharge',
    placeholderMtq: 'Enter MTQ',
    placeholderTne: 'Enter TNE',
    placeholderFreightTwenty: 'Enter 20ft base freight',
    placeholderFreightForty: 'Enter 40ft base freight',
    placeholderPortSurchargeTwenty: 'Enter 20ft port surcharge',
    placeholderPortSurchargeForty: 'Enter 40ft port surcharge',
    placeholderFuelTwenty: 'Enter 20ft fuel surcharge',
    placeholderFuelForty: 'Enter 40ft fuel surcharge',
    msgHarborInfoFail: 'Failed to load harbor info',
